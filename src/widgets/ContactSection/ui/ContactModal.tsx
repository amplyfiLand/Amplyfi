              ...
              <>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.field}>
                    ...
                    <textarea className={styles.textarea} placeholder="Tell us about yourself..." rows={4} value={form.message} onChange={handleChange("message")} required maxLength={2000} />
                    <span className={styles.fieldHint}>{form.message.length}/2000</span>
                  </div>
